...
API key — это то, что En Parlant~ использует для связи с серверами Google.
...
TTS-плагин разработан Darrell из [Red Shed](https://redshed.ai) с помощью [Claude Code](https://claude.ai/claude-code). Поддержка нескольких языков, интеграция с двумя провайдерами, перевод шахматной терминологии на семь языков — собрано из исходников, протестировано вручную и передано с заботой.
