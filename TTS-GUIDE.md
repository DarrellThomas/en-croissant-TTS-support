...
**[ElevenLabs Setup Guide](docs/tts/setup-elevenlabs.md)**
...
**[Google Cloud Setup Guide](docs/tts/setup-google.md)**
...
**[KittenTTS Setup Guide](docs/tts/setup-kittentts.md)**
...
**[System TTS Setup Guide](docs/tts/setup-system.md)**
...
**[OpenTTS Setup Guide](docs/tts/setup-opentts.md)**
...
We used AI to help build this. [Read about that here](docs/ai-note.md).
