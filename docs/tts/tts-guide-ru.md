...
API key — это то, что En Croissant-TTS Support использует для связи с серверами Google.
...
### Шаг 5: Настройте En Croissant-TTS Support

Почти готово!

1. Откройте En Croissant-TTS Support и перейдите в **Settings** (значок шестерёнки) > вкладка **Sound**
...
### Шаг 3: Настройте En Croissant-TTS Support
