...
L'API key est ce qu'En Croissant-TTS utilise pour communiquer avec les serveurs de Google.
...
### Etape 5 : Configurer En Croissant-TTS

Vous y etes presque !

1. Ouvrez En Croissant-TTS et allez dans **Settings** (icone d'engrenage) > onglet **Sound**
...
### Etape 3 : Configurer En Croissant-TTS
