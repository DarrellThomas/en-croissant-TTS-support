...
En Croissant-TTS Support comes with a selection of databases to download with a single click.
...
Databases can be downloaded directly from within the app via the Databases page.
