...
export const createSidecarFilesAtom = atomWithStorage<boolean>("create-sidecar-files", true);
...
export const ttsEnabledAtom = atomWithStorage<boolean>("tts-enabled", true, undefined, {
    getOnInit: true,
});
export const ttsAutoNarrateAtom = atomWithStorage<boolean>("tts-auto-narrate", true, undefined, {
    getOnInit: true,
});
export const ttsApiKeyAtom = atomWithStorage<string>("tts-api-key", "", undefined, {
    getOnInit: true,
});
...
export const ttsVolumeAtom = atomWithStorage<number>("tts-volume", 0.8, undefined, {
    getOnInit: true,
});
export const ttsSpeedAtom = atomWithStorage<number>("tts-speed", 1.0, undefined, {
    getOnInit: true,
});
export const ttsLanguageAtom = atomWithStorage<string>("tts-language", "en", undefined, {
    getOnInit: true,
});
...
export const ttsGoogleGenderAtom = atomWithStorage<string>("tts-google-gender", "MALE", undefined, {
    getOnInit: true,
});
...
export const ttsOpenTTSVoiceAtom = atomWithStorage<string>("tts-opentts-voice", "", undefined, {
    getOnInit: true,
});
export const ttsSystemVoiceAtom = atomWithStorage<string>("tts-system-voice", "", undefined, {
    getOnInit: true,
});
...
export const ttsLocalServerStatusAtom = atom<"idle" | "starting" | "running">("idle");
...
export const docLangAtom = atomWithStorage<string>("doc-language", "en", undefined, {
    getOnInit: true,
});
...
export const playerNameAtom = atomWithStorage<string>("player-name", "Player", undefined, {
    getOnInit: true,
});
...
const localColorFamily = atomFamily((tab: string) => atom<"white" | "black" | null>(null));
...
const drawOfferFamily = atomFamily((tab: string) => atom({ offered: false, received: false }));
