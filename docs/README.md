# En Croissant-TTS Support Documentation

## What is En Croissant-TTS Support?

En Croissant-TTS Support is an open-source, cross-platform chess GUI that aims to be powerful, customizable and easy to use. It functions as a chess database and analysis tool, bridging the user experience of online chess websites with the powerful features only a desktop application can offer.
...
- **This fork:** <https://github.com/DarrellThomas/en-croissant-TTS-support>
