...
**[ElevenLabs Einrichtungsanleitung](docs/tts/setup-elevenlabs.md)** *(auf Englisch)*
...
**[Google Cloud Einrichtungsanleitung](docs/tts/setup-google.md)** *(auf Englisch)*
...
**[KittenTTS Einrichtungsanleitung](docs/tts/setup-kittentts.md)** *(auf Englisch)*
...
**[System TTS Einrichtungsanleitung](docs/tts/setup-system.md)** *(auf Englisch)*
...
**[OpenTTS Einrichtungsanleitung](docs/tts/setup-opentts.md)** *(auf Englisch)*
...
Wir haben KI benutzt, um dies zu bauen. [Mehr erfahren](docs/ai-note.md).
