...
## BATCH 6: Large Enhancements — ⬜ ALL OPEN (0/23)
...
## BATCH 7: Upstream Cherry-Picks (v0.15.0+) — ✅ MOSTLY DONE (3/15)
...
| Upstream          | Title                                                 | Priority | Status   |
| ----------------- | ----------------------------------------------------- | -------- | -------- | -------- |
| PR #710           | Variation/comment/NAG encoding in database            | High     | ✅ Fixed | 19309c78 |
...
| BATCH 7: Upstream Cherry-Picks (v0.15.0+) | 15     | **3** ✅  | **12** |
| **TOTAL**                                 | **96** | **37**    | **59** |

**37 issues resolved. 59 remaining.**

Next highest-impact targets:

1. **`b8612591`** — Fix React Compiler for Vite 8
2. **`afbe3172`** — Tab icons
3. **`262fa5a6`** — Fix puzzle bug
4. **`b2fcf250`** — Database info in info panel
