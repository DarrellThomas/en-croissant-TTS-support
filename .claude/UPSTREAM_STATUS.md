...
## BATCH 4: Easy Enhancements — ⬜ ALL OPEN (0/14)

| # | Title | Relevance | Status |
|---|---|---|---|
| #254 | Arrow keys navigate tabs instead of moves | High | ⬜ Open |
| #301 | Allow up to 8 analysis lines (not just 5) | High | ⬜ Open |
...
| #708 | Support PGN `[%timestamp]` syntax | High | ⬜ Open |
| #393 | Option to download unrated Lichess games | Medium | ⬜ Open |
...
| BATCH 4: Easy Enhancements | 14 | 0 | **14** |
| BATCH 5: Moderate Enhancements | 23 | 0 | **23** |
| BATCH 6: Large Enhancements | 23 | 0 | **23** |
| **TOTAL** | **81** | **20** | **61** |

**20 issues resolved. 61 remaining.**

Next highest-impact targets (quick wins from Batch 4):
1. **#254** — Arrow keys navigate tabs (keyboard UX, annoying daily)
2. **#301** — Allow up to 8 analysis lines (1-line slider change)
3. **#495** — Auto-start engine on new board (reduces clicks)
4. **#510** — Copy engine output to clipboard
5. **#534** — Save engine line without navigating there
6. **#708** — PGN `[%timestamp]` support (Chess.com imports)
