...
def main():
    ...
    # ── jobs ───────────────────────────────────────────────────────────────────
    pj = ep_jobs.register_argparse(sub)
    ...
    if args.command == "import":
        ...
        fn = ep_jobs.DISPATCH.get(args.jobs_cmd)
        if fn: fn(conn, args)
        else:  pj.print_help()
        ...
        ep_serve.cmd_serve(conn, args,
            now_utc=now_utc, git_head=git_head, audit=audit,
            export_upstream_status=export_upstream_status,
            export_tasks_md=export_tasks_md)
