...
const CHESS_VOCAB: Record<string, ChessVocab> = {
    ...
    it: {
        ...
        Bishop: "Alfiere",
        Knight: "Cavallo",
        castlesKingside: "arrocco corto",
        castlesQueenside: "arrocco lungo",
        takes: "cattura",
        check: "scacco",
        ...
        good: "Buona mossa.",
        interesting: "Mossa interessante.",
        dubious: "Mossa dubbia.",
        mistake: "Errore.",
    ...
    pt: {
        ...
        Bishop: "Bispo",
        Knight: "Cavalo",
        castlesKingside: "roque menor",
        castlesQueenside: "roque maior",
        takes: "captura",
        check: "xeque",
        checkmate: "xeque-mate",
        promotesTo: "promove a",
        brilliant: "Jogada brilhante.",
        good: "Boa jogada.",
        interesting: "Jogada interessante.",
        dubious: "Jogada duvidosa.",
        mistake: "Erro.",
        blunder: "Erro grave.",
    },
    nl: {
        ...
        Bishop: "Loper",
        Knight: "Paard",
        castlesKingside: "korte rokade",
        castlesQueenside: "lange rokade",
        takes: "slaat",
        check: "schaak",
        checkmate: "schaakmat",
        promotesTo: "promoveert tot",
        brilliant: "Briljante zet.",
        good: "Goede zet.",
        interesting: "Interessante zet.",
        dubious: "Twijfelachtige zet.",
        mistake: "Fout.",
        blunder: "Blunder.",
    },
    pl: {
        ...
        Bishop: "Goniec",
        Knight: "Skoczek",
        castlesKingside: "roszada krótka",
        castlesQueenside: "roszada długa",
        takes: "bije",
        check: "szach",
        checkmate: "szach-mat",
        promotesTo: "promuje na",
        brilliant: "Świetne posunięcie.",
        good: "Dobre posunięcie.",
        interesting: "Ciekawe posunięcie.",
        dubious: "Wątpliwe posunięcie.",
        mistake: "Błąd.",
    ...
    tr: {
        ...
        Bishop: "Fil",
        Knight: "At",
        castlesKingside: "kısa rok",
        castlesQueenside: "uzun rok",
        takes: "alır",
        check: "şah",
        checkmate: "şah mat",
        promotesTo: "terfi eder",
        brilliant: "Harika hamle.",
        good: "İyi hamle.",
        interesting: "İlginç hamle.",
        dubious: "Şüpheli hamle.",
        mistake: "Hata.",
        blunder: "Büyük hata.",
    },
    ar: {
        ...
        Bishop: "فيل",
        Knight: "حصان",
        castlesKingside: "تبييت قصير",
        castlesQueenside: "تبييت طويل",
        takes: "يأخذ",
        check: "كش",
        checkmate: "كش ملك",
        promotesTo: "يترقى إلى",
        brilliant: "نقلة رائعة.",
        good: "نقلة جيدة.",
        interesting: "نقلة مثيرة.",
        dubious: "نقلة مشكوك فيها.",
        mistake: "خطأ.",
        blunder: "خطأ فادح.",
    },
    sv: {
        ...
        Bishop: "Löpare",
        Knight: "Springare",
        castlesKingside: "kort rockad",
        castlesQueenside: "lång rockad",
        takes: "slår",
        check: "schack",
        checkmate: "schack matt",
        promotesTo: "uppflyttning till",
        brilliant: "Briljant drag.",
        good: "Bra drag.",
        interesting: "Intressant drag.",
        dubious: "Tveksamt drag.",
        mistake: "Misstag.",
        blunder: "Grovt misstag.",
    },
    no: {
        King: "Konge",
        Queen: "Dronning",
        ...
        Bishop: "Løper",
        Knight: "Springer",
        castlesKingside: "kort rokade",
        castlesQueenside: "lang rokade",
        takes: "slår",
        check: "sjakk",
        checkmate: "sjakk matt",
        promotesTo: "forvandling til",
        brilliant: "Strålende trekk.",
        good: "Godt trekk.",
        interesting: "Interessant trekk.",
        dubious: "Tvilsomt trekk.",
        mistake: "Feil.",
        blunder: "Grov feil.",
    },
    da: {
        ...
        checkmate: "skakmat",
        promotesTo: "forvandling til",
        brilliant: "Brillant træk.",
        good: "Godt træk.",
        interesting: "Interessant træk.",
        dubious: "Tvivlsomt træk.",
        mistake: "Fejl.",
        blunder: "Grov fejl.",
    },
    cs: {
        ...
        Bishop: "Střelec",
        Knight: "Jezdec",
        castlesKingside: "krátká rošáda",
        castlesQueenside: "dlouhá rošáda",
        takes: "bere",
        check: "šach",
        checkmate: "šach mat",
        promotesTo: "proměňuje na",
        brilliant: "Brilantní tah.",
        good: "Dobrý tah.",
        interesting: "Zajímavý tah.",
        dubious: "Pochybný tah.",
        mistake: "Chyba.",
        blunder: "Hrubá chyba.",
    },
    hu: {
        ...
        Bishop: "Futó",
        Knight: "Huszár",
        castlesKingside: "rövid sáncolás",
        castlesQueenside: "hosszú sáncolás",
        takes: "üt",
        check: "sakk",
        checkmate: "sakk-matt",
        promotesTo: "átváltozik",
        brilliant: "Brilliáns lépés.",
        good: "Jó lépés.",
        interesting: "Érdekes lépés.",
        dubious: "Kétes lépés.",
        mistake: "Hiba.",
        blunder: "Durva hiba.",
    },
    uk: {
        ...
        Bishop: "Слон",
        Knight: "Кінь",
        castlesKingside: "коротка рокіровка",
        castlesQueenside: "довга рокіровка",
        takes: "бере",
        check: "шах",
        checkmate: "мат",
        promotesTo: "перетворюється на",
        brilliant: "Блискучий хід.",
        good: "Гарний хід.",
        interesting: "Цікавий хід.",
        dubious: "Сумнівний хід.",
        mistake: "Помилка.",
        ...
        Bishop: "Lähetti",
        Knight: "Ratsu",
        castlesKingside: "lyhyt linna",
        castlesQueenside: "pitkä linna",
        takes: "lyö",
        check: "shakki",
        checkmate: "shakkimatti",
        promotesTo: "korottuu",
        brilliant: "Loistava siirto.",
        good: "Hyvä siirto.",
        interesting: "Mielenkiintoinen siirto.",
        dubious: "Kyseenalainen siirto.",
        mistake: "Virhe.",
        blunder: "Karkea virhe.",
    },
};
...
function expandInlineSAN(text: string, lang: string): string {
    ...
    text = text.replace(/\b([KQRBN][a-h]?x?[a-h][1-8][+#]?)(?!\w)/g, (_match, san) =>
        sanToSpoken(san, lang),
    );
...
export function annotationsToSpoken(annotations: string[], lang = "en"): string {
...
const GOOGLE_VOICES: Record<string, Record<string, GoogleVoice>> = {
    ...
    fr: {
        MALE: { languageCode: "fr-FR", name: "fr-FR-WaveNet-B" },
        FEMALE: { languageCode: "fr-FR", name: "fr-FR-WaveNet-A" },
    },
    es: {
        MALE: { languageCode: "es-ES", name: "es-ES-WaveNet-B" },
        FEMALE: { languageCode: "es-ES", name: "es-ES-WaveNet-C" },
    },
    de: {
        MALE: { languageCode: "de-DE", name: "de-DE-WaveNet-B" },
        FEMALE: { languageCode: "de-DE", name: "de-DE-WaveNet-A" },
    },
    ja: {
    ...
    // --- Expanded WaveNet languages ---
    ar: {
        MALE: { languageCode: "ar-XA", name: "ar-XA-WaveNet-B" },
        FEMALE: { languageCode: "ar-XA", name: "ar-XA-WaveNet-A" },
    },
    bn: {
        MALE: { languageCode: "bn-IN", name: "bn-IN-WaveNet-B" },
        FEMALE: { languageCode: "bn-IN", name: "bn-IN-WaveNet-A" },
    },
    cs: {
        // Female only — WaveNet-A is the only WaveNet voice for Czech
        MALE: { languageCode: "cs-CZ", name: "cs-CZ-WaveNet-A" },
        FEMALE: { languageCode: "cs-CZ", name: "cs-CZ-WaveNet-A" },
    },
    da: {
        MALE: { languageCode: "da-DK", name: "da-DK-WaveNet-C" },
        FEMALE: { languageCode: "da-DK", name: "da-DK-WaveNet-A" },
    },
    el: {
        // Female only
        MALE: { languageCode: "el-GR", name: "el-GR-WaveNet-A" },
        FEMALE: { languageCode: "el-GR", name: "el-GR-WaveNet-A" },
    },
    fi: {
        // Female only
        MALE: { languageCode: "fi-FI", name: "fi-FI-WaveNet-A" },
        FEMALE: { languageCode: "fi-FI", name: "fi-FI-WaveNet-A" },
    },
    fil: {
    ...
    hi: {
        MALE: { languageCode: "hi-IN", name: "hi-IN-WaveNet-B" },
        FEMALE: { languageCode: "hi-IN", name: "hi-IN-WaveNet-A" },
    },
    hu: {
        // Female only
        MALE: { languageCode: "hu-HU", name: "hu-HU-WaveNet-A" },
        FEMALE: { languageCode: "hu-HU", name: "hu-HU-WaveNet-A" },
    },
    id: {
        MALE: { languageCode: "id-ID", name: "id-ID-WaveNet-D" },
        FEMALE: { languageCode: "id-ID", name: "id-ID-WaveNet-A" },
    },
    it: {
        MALE: { languageCode: "it-IT", name: "it-IT-WaveNet-C" },
        FEMALE: { languageCode: "it-IT", name: "it-IT-WaveNet-A" },
    },
    nl: {
        MALE: { languageCode: "nl-NL", name: "nl-NL-WaveNet-B" },
        FEMALE: { languageCode: "nl-NL", name: "nl-NL-WaveNet-A" },
    },
    no: {
        MALE: { languageCode: "nb-NO", name: "nb-NO-WaveNet-B" },
        FEMALE: { languageCode: "nb-NO", name: "nb-NO-WaveNet-A" },
    },
    pl: {
        MALE: { languageCode: "pl-PL", name: "pl-PL-WaveNet-B" },
        FEMALE: { languageCode: "pl-PL", name: "pl-PL-WaveNet-A" },
    },
    pt: {
        MALE: { languageCode: "pt-BR", name: "pt-BR-WaveNet-B" },
        FEMALE: { languageCode: "pt-BR", name: "pt-BR-WaveNet-A" },
    },
    ro: {
        // Female only
        MALE: { languageCode: "ro-RO", name: "ro-RO-WaveNet-A" },
        FEMALE: { languageCode: "ro-RO", name: "ro-RO-WaveNet-A" },
    },
    sk: {
        // Female only
        MALE: { languageCode: "sk-SK", name: "sk-SK-WaveNet-A" },
        FEMALE: { languageCode: "sk-SK", name: "sk-SK-WaveNet-A" },
    },
    sv: {
        MALE: { languageCode: "sv-SE", name: "sv-SE-WaveNet-B" },
        FEMALE: { languageCode: "sv-SE", name: "sv-SE-WaveNet-A" },
    },
    th: {
        MALE: { languageCode: "th-TH", name: "th-TH-WaveNet-B" },
        FEMALE: { languageCode: "th-TH", name: "th-TH-WaveNet-A" },
    },
    tr: {
        MALE: { languageCode: "tr-TR", name: "tr-TR-WaveNet-B" },
        FEMALE: { languageCode: "tr-TR", name: "tr-TR-WaveNet-A" },
    },
    uk: {
        // Female only
        MALE: { languageCode: "uk-UA", name: "uk-UA-WaveNet-A" },
        FEMALE: { languageCode: "uk-UA", name: "uk-UA-WaveNet-A" },
    },
    vi: {
        MALE: { languageCode: "vi-VN", name: "vi-VN-WaveNet-B" },
        ...
        try {
            ...
            if (!blobUrl) {
                ...
                if (provider === "kittentts") {
                    ...
                    audioData = await generateSpeech(text, apiKey, voiceId, lang, abort.signal);
                }
            ...
            if (e instanceof TypeError && /cancel|abort/i.test(e.message)) return;
...
export async function speakComment(comment: string, headers?: GameHeaders): Promise<void> {
