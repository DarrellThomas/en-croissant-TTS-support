...
**[Guide de configuration ElevenLabs](docs/tts/setup-elevenlabs.md)** *(en anglais)*
...
**[Guide de configuration Google Cloud](docs/tts/setup-google.md)** *(en anglais)*
...
**[Guide de configuration KittenTTS](docs/tts/setup-kittentts.md)** *(en anglais)*
...
**[Guide de configuration System TTS](docs/tts/setup-system.md)** *(en anglais)*
...
**[Guide de configuration OpenTTS](docs/tts/setup-opentts.md)** *(en anglais)*
...
Nous avons utilise l'IA pour construire ceci. [En savoir plus](docs/ai-note.md).
