...
API key 是 En Croissant-TTS Support 与 Google 服务器通信的凭证。
...
### 第五步：配置 En Croissant-TTS Support

就差最后一步了！

1. 打开 En Croissant-TTS Support，进入 **Settings**（齿轮图标）> **Sound** 选项卡
2. 向下滚动到 TTS 区域
...
### 第三步：配置 En Croissant-TTS Support
