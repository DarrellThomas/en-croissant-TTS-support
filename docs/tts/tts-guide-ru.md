...
API key — это то, что En Croissant-TTS использует для связи с серверами Google.
...
### Шаг 5: Настройте En Croissant-TTS

Почти готово!

1. Откройте En Croissant-TTS и перейдите в **Settings** (значок шестерёнки) > вкладка **Sound**
...
### Шаг 3: Настройте En Croissant-TTS
